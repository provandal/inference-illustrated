...
// Value vectors and their attention weights for the worked example
...
const entries = [
  { label: 'controller', vector: V_controller, weight: 0.42 },
  { label: 'crashed',    vector: V_crashed,    weight: 0.25 },
  { label: 'server',     vector: V_server,     weight: 0.15 },
  { label: 'was',        vector: V_was,        weight: 0.10 },
  { label: 'last',       vector: V_last,       weight: 0.08 },
];
