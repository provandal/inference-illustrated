// Stop 17: Intelligent Routing — Where Should This Request Go?
...
export const PAGES = [
  ...
  { id: 'summary',             label: 'Stop 17 at a Glance',               type: 'static' },
];
...
export const ROUTING_SCENARIOS = [
  ...
  },
  {
    ...
    stages: [
      ...
      { key: 'scoring',  title: 'Scoring',         text: 'Cache scores are all zero. Route to the prefill pool (disaggregated serving, Stop 13).' },
